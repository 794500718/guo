...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="box">
					<div class="box-header with-border">
						<c:if test="${!empty info }">
							...
							<script type="text/javascript">
								setTimeout(function(){
									location.href="/hotel/admin/page/client-add.jsp";
								},2000);
							</script>
						</c:if>
					</div>
					<div class="box-body">
						<div class="register-logo">
							<a href="/hotel/admin/index2.html"><b>会员注册</b>RAM</a>
						</div>

						<div class="register-box-body">
							<p class="login-box-msg">Register a new membership</p>

							<form id="add_client_form" action="/hotel/app/client/add" method="post">
								...
								<div class="row">
									...
									<!-- /.col -->
									<div class="col-xs-4">
										<button type="button" id="add_client_btn"
							...
							<a href="login.html" class="text-center">我早已拥有会员！</a>
						</div>
	...
	<script src="/hotel/admin/dist/js/client.js" type="text/javascript"></script>
	<script>
